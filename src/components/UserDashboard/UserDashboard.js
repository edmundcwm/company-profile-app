...
//   componentDidMount() {
//     if (!dataStore.cache.userOrdersCached) {
//       const endpoint = 'nerbcrmwp/v1/orders/';

//       UserServices.getByEmail(this.source.token, endpoint)
//         .then(response => {
//           dataStore.data.userOrders = response.data;
//           if (!dataStore.data.userOrders.length) {
//             errorMessage = 'No Orders found.';
//           }
//           this.setState({ isLoading: false });
//           dataStore.cache.userOrdersCached = true;
//         })
//         .catch(error => {
//           if (axios.isCancel(error)) {
//             console.log('request cancelled');
//           } else {
//             console.log(error);
//             errorMessage = 'Failed to fetch data. Please contact support.';
//             this.setState({ isLoading: false });
//           }
//         });
//     } else {
